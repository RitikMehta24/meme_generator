function clearAll() {
  //here whenever this method is called we clear the previou value and ser to empty 
  const memecontain = document.querySelector('.meme-content');
  const jokecontain = document.querySelector('.joke-content');
  const qoutecontain = document.querySelector('.qoute-content');
  const riddlecontain = document.querySelector('.riddle-content');
  memecontain.innerHTML = '';
  jokecontain.innerHTML = '';
  qoutecontain.innerHTML = '';
  riddlecontain.innerHTML = '';
  //also when we call other functiop it will clear other funtion 
  //like calling meme will clear joke
}
...
function showMeme() {
  ...
  // if (isImg) {
  //   container.innerHTML='';
  //so here we just set the value of html to null or say empty
  // }
  //or same thing but done by method 
  clearAll();
...
function showQuote() {
  ...
  clearAll();
  // document.querySelector('.qoute-content').appendChild(quote);
  // document.querySelector('.qoute-content').appendChild(author);
  //or
  const con = document.querySelector('.qoute-content');
  con.appendChild(quote);
...
function showRiddle() {
  ...
  clearAll();
  const cont = document.querySelector('.riddle-content');
